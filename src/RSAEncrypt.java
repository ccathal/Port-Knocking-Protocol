...
public class RSAEncrypt {
	...
	public static byte[] encrypt(String publicKey, String plainText) throws BadPaddingException,
	...
	// encryption method
	// takes the string to be enrypted and the Base64 encoded RSA key for encryption
	public static byte[] encryptKey(String publicKey, SecretKey secKey) throws BadPaddingException,
			IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException {
		Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
		cipher.init(Cipher.ENCRYPT_MODE, getPublicKey(publicKey));
	...
	// decryption methods
	// decrypt method that accepts RSA encrypted string and Base64 encoded RSA
	// private key for decryption
	public static byte[] decrypt(String privateKey, String data) throws IllegalBlockSizeException, InvalidKeyException,
