...
public class ClientGui extends JFrame {
	...
	public ClientGui() {
		...
		knock.setBorder(BorderFactory.createEmptyBorder(15, 10, 15, 10));
		...
		for (int i = 3; i < 7; i++) {
			...
			button.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					// FRAME 2 :- contains input fields for server port, ipaddress and knock
					// sequence
					...
					// loop to create port knock input field corresponting to the number on the
